 ...
 * i_navigate_to_the_edfstage_url_in(String arg1) throws Throwable{ // first set
 * browser name browserDetails.setBrowserName(arg1); //initialize the driver
 * object now driver = AppDriver.getInstance(); //initialize the page object
 * element inside the first method eDFHomePageElements = new
 * EDFHomePageElements(); System.out.println(driver + " EDFHomePage");
