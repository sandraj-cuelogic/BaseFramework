...
public class GenericFunctions  {
	...
	static LucencyHomePage homepage;
	static  WebDriver driver = objManager.getAppDriver();
	...
	public void selectByValue(By numberType, String value) {
		Select select = new Select(driver.findElement(numberType));
...
//		Actions action=new Actions(driver);
	...
	public String generateRandomText(int textLength) {
		...
		AutomationLog.info(randomText);
		return randomText;
	}
	
	public String generateRandomNumbers(int numberLength) {
		String randomNumbers = RandomStringUtils.randomNumeric(numberLength);
		AutomationLog.info(randomNumbers);
		return randomNumbers;
	}
	
	public String generateRandomEmailid() {
		String randomEmail = RandomStringUtils.randomNumeric(2)+RandomStringUtils.randomAlphabetic(5) + "@" + "yopmail.com";
		AutomationLog.info(randomEmail);
		return randomEmail;
	...
	public static void verifyEmail(String emailId, String EmailFrom, String EmailTitle) {
		...
		try {
			...
			driver.findElement(homepage.LoginIcon).sendKeys(emailId);
...
//						driver.findElement(By.id("e0")).click();
						String emailFrom = driver.findElement(By.xpath("//*[@class='m']["+i+"]/descendant::a/span[1]")).getText();
						String emailTitle = driver.findElement(By.xpath("//*[@class='m']["+i+"]/descendant::a/span[2]")).getText();
						...
						if(emailTitle.contains(EmailTitle)) {
							 ...
							 System.out.println(driver.findElement(By.xpath("//a[contains(text(),'Reset Password')]")).getText());
			...
			AutomationLog.error("Failed to verify email " + e.toString());
		}
