...
@CucumberOptions(
		...
		plugin = { "com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/LucencyLogin_Report.html" }, 
		monochrome = true,
		tags = "@LucencyLogin")
...
//			WebDriver driver = AppDriver.getInstance();
	...
	public static void afterTest() throws IOException {
		...
		copyReports.copyReportToReportsPath("LucencyLogin_Report.html");
