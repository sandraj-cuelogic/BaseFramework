...
public class testCheck {
	...
	@Given("^I navigate  to edfstage url in \"([^\"]*)\"$")
	public void i_navigate_to_edfstage_url_in(String arg1) throws Throwable {
...
//	    throw new PendingException();
	...
	@When("^the page has title as \"([^\"]*)\"$")
	public void the_page_has_title_as(String arg1) throws Throwable {
		title = eDFHomePageElements.txt_Header().getText();
		log.info("Title of the page is as " +title);

	}

	@Then("^confirm that user has reached EDF's landing webpage$")
	public void confirm_that_user_has_reached_EDF_s_landing_webpage() throws Throwable {
